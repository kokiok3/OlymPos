...
const schema = Joi.object({
    isErrorPhone: Joi.string().empty(''),
    isErrorEmail: Joi.string().required()
});
...
const validate = ()=>{
    ...
    return;
    return schema.validate({isErrorPhone: signUp.value.phone, isErrorEmail: signUp.value.email}, {abortEarly: false});
}
const signUp = ref({
    phone: {},
    email: ''
